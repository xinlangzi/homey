...
RSpec.describe Backend::PropertiesController, type: :controller do
  before do
    sign_in admin
  end
  ...
  # PropertysController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all propertys as @propertys" do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created property" do
        post :create, {:property => valid_attributes}, valid_session
        expect(response).to redirect_to([:backend, Property.last])
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested property" do
        ...
        property.reload
        expect(property.title).to eq("truly beautiful")
      end
      ...
      it "redirects to the property" do
        property = Property.create! valid_attributes
        put :update, {:id => property.to_param, :property => valid_attributes}, valid_session
        expect(response).to redirect_to([:backend, property])
      end
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the propertys list" do
      property = Property.create! valid_attributes
      delete :destroy, {:id => property.to_param}, valid_session
      expect(response).to redirect_to(backend_properties_url)
    end
  end
