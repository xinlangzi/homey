class Backend::BannersController < Backend::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @banner.save
        format.html { redirect_to [:backend, @banner], notice: 'Banner was successfully created.' }
  ...
  def destroy
    @banner.destroy
    respond_to do |format|
      format.html { redirect_to backend_banners_url, notice: 'Banner was successfully destroyed.' }
